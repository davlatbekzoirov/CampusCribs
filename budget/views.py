...
def budget_dashboard(request):
    ...
    # Mathematical Framework for Predictive Runway
    ...
    # Semi-static calculation for semester milestone configuration
    semester_end = date(2026, 12, 20)
    days_remaining = (semester_end - date.today()).days
    days_remaining = max(0, days_remaining)
    
    # Daily spending velocity equation over trailing 14-day window
